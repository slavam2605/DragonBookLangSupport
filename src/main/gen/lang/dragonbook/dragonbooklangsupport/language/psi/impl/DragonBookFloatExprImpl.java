...
public class DragonBookFloatExprImpl extends DragonBookExpressionImpl implements DragonBookFloatExpr {

  public DragonBookFloatExprImpl(@NotNull ASTNode node) {
    super(node);
  }
