...
public abstract class DragonBookExpressionImpl extends ASTWrapperPsiElement implements DragonBookExpression {

  public DragonBookExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
