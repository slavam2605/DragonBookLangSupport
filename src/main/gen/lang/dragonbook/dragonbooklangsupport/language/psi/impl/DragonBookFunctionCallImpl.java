...
public class DragonBookFunctionCallImpl extends ASTWrapperPsiElement implements DragonBookFunctionCall {

  public DragonBookFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DragonBookCallArguments getCallArguments() {
    return findChildByClass(DragonBookCallArguments.class);
  }
