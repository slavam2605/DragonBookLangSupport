...
public class DragonBookContinueStatementImpl extends ASTWrapperPsiElement implements DragonBookContinueStatement {

  public DragonBookContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
