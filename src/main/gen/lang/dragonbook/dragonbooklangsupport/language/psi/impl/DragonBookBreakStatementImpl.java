...
public class DragonBookBreakStatementImpl extends ASTWrapperPsiElement implements DragonBookBreakStatement {

  public DragonBookBreakStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
