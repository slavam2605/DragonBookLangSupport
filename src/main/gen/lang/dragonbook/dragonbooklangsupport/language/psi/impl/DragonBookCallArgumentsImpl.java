...
public class DragonBookCallArgumentsImpl extends ASTWrapperPsiElement implements DragonBookCallArguments {

  public DragonBookCallArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
