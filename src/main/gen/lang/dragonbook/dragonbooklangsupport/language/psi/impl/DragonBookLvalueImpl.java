...
public class DragonBookLvalueImpl extends ASTWrapperPsiElement implements DragonBookLvalue {

  public DragonBookLvalueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DragonBookDerefLValue getDerefLValue() {
    return findChildByClass(DragonBookDerefLValue.class);
  }

  @Override
  @Nullable
  public DragonBookIdLValue getIdLValue() {
    return findChildByClass(DragonBookIdLValue.class);
  }
