...
public class DragonBookMulDivExprImpl extends DragonBookExpressionImpl implements DragonBookMulDivExpr {

  public DragonBookMulDivExprImpl(@NotNull ASTNode node) {
    super(node);
  }
