...
public class DragonBookErrorStatementImpl extends ASTWrapperPsiElement implements DragonBookErrorStatement {

  public DragonBookErrorStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
