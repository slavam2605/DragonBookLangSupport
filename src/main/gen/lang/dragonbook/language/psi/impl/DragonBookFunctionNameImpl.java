...
public class DragonBookFunctionNameImpl extends ASTWrapperPsiElement implements DragonBookFunctionName {

  public DragonBookFunctionNameImpl(@NotNull ASTNode node) {
    super(node);
  }
