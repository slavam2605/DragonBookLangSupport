...
public class DragonBookComparisonOpImpl extends ASTWrapperPsiElement implements DragonBookComparisonOp {

  public DragonBookComparisonOpImpl(@NotNull ASTNode node) {
    super(node);
  }
