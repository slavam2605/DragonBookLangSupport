...
public class DragonBookAnnotationListImpl extends ASTWrapperPsiElement implements DragonBookAnnotationList {

  public DragonBookAnnotationListImpl(@NotNull ASTNode node) {
    super(node);
  }
