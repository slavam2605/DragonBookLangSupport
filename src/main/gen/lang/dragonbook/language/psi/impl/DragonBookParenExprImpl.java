...
public class DragonBookParenExprImpl extends DragonBookExpressionImpl implements DragonBookParenExpr {

  public DragonBookParenExprImpl(@NotNull ASTNode node) {
    super(node);
  }
