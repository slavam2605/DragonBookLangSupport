...
public class DragonBookDoWhileStatementImpl extends ASTWrapperPsiElement implements DragonBookDoWhileStatement {

  public DragonBookDoWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
