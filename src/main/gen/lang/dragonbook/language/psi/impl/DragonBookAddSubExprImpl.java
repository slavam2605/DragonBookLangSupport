...
public class DragonBookAddSubExprImpl extends DragonBookExpressionImpl implements DragonBookAddSubExpr {

  public DragonBookAddSubExprImpl(@NotNull ASTNode node) {
    super(node);
  }
